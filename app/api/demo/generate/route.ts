      ...
      await transporter.sendMail({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0D1520;padding:24px;border-radius:12px;">
            <p style="color:#22D6DC;font-size:11px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;margin:0 0 8px;">Old Crows Wireless Solutions</p>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:13px;">
              ...
              <tr><td style="color:#888;padding:8px 0;">Token</td><td style="color:#22D6DC;padding:8px 0;text-align:right;font-family:monospace;">${token.token}</td></tr>
            </table>
            <div style="margin:20px 0;background:#1A2332;border:1px solid rgba(34,214,220,0.3);border-radius:8px;padding:16px;text-align:center;">
              <p style="color:#888;font-size:11px;margin:0 0 8px;">DEMO LINK — FORWARD THIS TO RECIPIENT</p>
              <a href="${tokenUrl}" style="color:#22D6DC;font-size:14px;word-break:break-all;">${tokenUrl}</a>
            </div>
