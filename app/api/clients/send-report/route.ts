...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: clientEmail,
      subject: `Your WiFi Health Report — ${locationName}`,
      html: `
        <div style="background:#0D1520;color:#F4F6F8;font-family:Inter,sans-serif;padding:40px;max-width:600px;margin:0 auto;border-radius:12px;">
          <div style="color:#22D6DC;font-size:12px;letter-spacing:0.1em;margin-bottom:8px;font-family:monospace;">OLD CROWS WIRELESS SOLUTIONS</div>
          <h1 style="color:#F4F6F8;font-size:22px;margin:0 0 8px;">Your WiFi Health Report is ready.</h1>
          <p style="color:#888;font-size:14px;line-height:1.7;margin:0 0 24px;">
            ...
            Log in to your Crow's Eye dashboard to view the full WiFi Health Report and download your branded PDF.
          </p>
