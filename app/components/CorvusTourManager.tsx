...
const s: Record<string, React.CSSProperties> = {
  ...
  heading: { color: '#22D6DC', fontFamily: 'Share Tech Mono, monospace', fontSize: '1rem', margin: '0 0 1.25rem' },
  ...
  select: { background: '#0D1520', border: '1px solid rgba(34,214,220,0.2)', borderRadius: '6px', color: '#F4F6F8', padding: '8px 10px', fontSize: '0.85rem' },
  input: { background: '#0D1520', border: '1px solid rgba(34,214,220,0.2)', borderRadius: '6px', color: '#F4F6F8', padding: '8px 10px', fontSize: '0.85rem' },
  playBtn: { background: 'linear-gradient(135deg, #0D6E7A, #22D6DC)', color: '#fff', border: 'none', borderRadius: '8px', padding: '12px 24px', fontSize: '1rem', fontWeight: 700, cursor: 'pointer', alignSelf: 'flex-start' },
  playHint: { color: '#555', fontSize: '0.78rem', margin: 0, fontStyle: 'italic' },
  divider: { height: '1px', background: 'rgba(34,214,220,0.1)', margin: '1rem 0' },
  shareBtn: { background: '#1A2332', border: '1px solid rgba(34,214,220,0.35)', color: '#22D6DC', borderRadius: '8px', padding: '10px 20px', fontSize: '0.9rem', cursor: 'pointer', fontWeight: 600, alignSelf: 'flex-start' },
  errorBox: { background: 'rgba(224,85,85,0.08)', border: '1px solid rgba(224,85,85,0.25)', borderRadius: '8px', padding: '0.6rem 0.85rem' },
  result: { background: 'rgba(34,214,220,0.07)', border: '1px solid rgba(34,214,220,0.2)', borderRadius: '10px', padding: '1rem', display: 'flex', flexDirection: 'column', gap: '0.6rem' },
  resultLabel: { color: '#22D6DC', fontFamily: 'Share Tech Mono, monospace', fontSize: '0.78rem', margin: 0 },
  urlRow: { display: 'flex', gap: '0.4rem' },
  urlInput: { flex: 1, background: '#0D1520', border: '1px solid rgba(34,214,220,0.3)', borderRadius: '6px', color: '#F4F6F8', padding: '9px 12px', fontSize: '0.82rem', fontFamily: 'monospace', cursor: 'text' },
  ...
  emailBtn: { background: 'rgba(216,172,50,0.12)', border: '1px solid rgba(216,172,50,0.3)', color: '#D8AC32', borderRadius: '6px', padding: '8px 16px', fontSize: '0.82rem', cursor: 'pointer', fontWeight: 600, alignSelf: 'flex-start' },
  emailRow: { display: 'flex', gap: '0.4rem', alignItems: 'center', flexWrap: 'wrap' },
  emailInput: { flex: 1, background: '#0D1520', border: '1px solid rgba(34,214,220,0.25)', borderRadius: '6px', color: '#F4F6F8', padding: '6px 10px', fontSize: '0.82rem', fontFamily: 'inherit', outline: 'none', minWidth: '180px' },
  ...
  sentConfirm: { color: '#22D6DC', fontSize: '0.78rem', fontFamily: 'Share Tech Mono, monospace', margin: 0 },
