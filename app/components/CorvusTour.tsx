...
export default function CorvusTour({ tour, onComplete, onSkip }: CorvusTourProps) {
  ...
  return (
    <>
      <style>{`
        @keyframes tour-glow {
          0%, 100% { box-shadow: 0 0 0 4px #22D6DC, 0 0 0 6px rgba(34,214,220,0.3), 0 0 20px rgba(34,214,220,0.4), 0 0 40px rgba(34,214,220,0.2); }
          50%       { box-shadow: 0 0 0 4px #22D6DC, 0 0 0 8px rgba(34,214,220,0.5), 0 0 30px rgba(34,214,220,0.6), 0 0 60px rgba(34,214,220,0.3); }
        }
      ...
      <div style={{
        ...
        {/* Gold top line */}
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg, #D8AC32, #22D6DC, #D8AC32)", borderRadius: "16px 16px 0 0" }} />

        {/* Header */}
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, flexShrink: 0 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/corvus_still.png" style={{ width: 48, height: 48, borderRadius: "50%", border: "2px solid #D8AC32", objectFit: "cover" }} alt="Corvus" />
            <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "0.45rem", color: "#22D6DC", letterSpacing: "0.15em" }}>CORVUS</span>
          </div>
          <div style={{ flex: 1 }}>
          ...
          {tour.steps.map((_, i) => (
            <div
              ...
              style={{
                ...
                background: i === currentStep ? "#22D6DC" : i < currentStep ? "rgba(34,214,220,0.4)" : "rgba(136,136,136,0.3)",
                cursor: "pointer",
                transition: "all 0.2s",
              }}
            />
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <button
            onClick={handleNext}
            style={{ flex: 1, padding: "8px 16px", background: "rgba(34,214,220,0.1)", border: "1px solid rgba(34,214,220,0.3)", borderRadius: 8, color: "#22D6DC", fontFamily: "'Share Tech Mono', monospace", fontSize: "0.65rem", cursor: "pointer", transition: "all 0.2s" }}
          >
