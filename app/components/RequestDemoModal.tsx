...
const s: Record<string, React.CSSProperties> = {
  ...
  modal: { background: '#1A2332', border: '1px solid rgba(34,214,220,0.2)', borderRadius: '16px', padding: '2rem', maxWidth: '540px', width: '100%', position: 'relative', maxHeight: '90vh', overflowY: 'auto' },
  ...
  input: { background: '#0D1520', border: '1px solid rgba(34,214,220,0.2)', borderRadius: '8px', padding: '9px 12px', color: '#F4F6F8', fontSize: '0.88rem', outline: 'none', width: '100%', boxSizing: 'border-box' },
  textarea: { background: '#0D1520', border: '1px solid rgba(34,214,220,0.2)', borderRadius: '8px', padding: '9px 12px', color: '#F4F6F8', fontSize: '0.88rem', outline: 'none', resize: 'vertical', fontFamily: 'inherit', width: '100%', boxSizing: 'border-box' },
  ...
  contactBtnActive: { background: 'rgba(34,214,220,0.1)', color: '#22D6DC', borderColor: '#22D6DC' },
  error: { color: '#e05555', fontSize: '0.82rem', margin: 0 },
  submitBtn: { background: 'linear-gradient(135deg, #0D6E7A, #22D6DC)', color: '#fff', border: 'none', borderRadius: '8px', padding: '13px', fontSize: '1rem', fontWeight: 700, cursor: 'pointer' },
  successBox: { textAlign: 'center', padding: '1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem' },
  successIcon: { width: '56px', height: '56px', borderRadius: '50%', background: 'rgba(34,214,220,0.12)', border: '2px solid #22D6DC', color: '#22D6DC', fontSize: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  closeBtn2: { background: 'rgba(34,214,220,0.1)', border: '1px solid rgba(34,214,220,0.2)', color: '#22D6DC', borderRadius: '8px', padding: '10px 24px', fontSize: '0.9rem', cursor: 'pointer', marginTop: '0.5rem' },
}
