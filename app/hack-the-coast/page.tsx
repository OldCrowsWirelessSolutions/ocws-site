...
export const metadata: Metadata = {
  ...
  description:
    'Enter your Hack the Coast event code to unlock a free Verdict and 24 hours of Talk to Corvus access.',
}
      ...
      >
        <div className="ocws-container text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
            Your event code unlocks<br />a real Corvus Verdict.
          </h1>
          <p className="text-base max-w-xl mx-auto mb-4" style={{ color: '#8AAABB' }}>
            Download Crow&rsquo;s Eye and let Corvus scan your network. He reads your RF data and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto items-start">
            ...
            <div>
              ...
              <ul className="space-y-5">
                {[
                  {
                    title: '1 Corvus Verdict',
                    body: 'Download Crow\'s Eye on Android, tap Scan, and Corvus automatically reads your RF environment and delivers a signed PDF diagnosis.',
                  },
                  {
                  ...
                  <li key={title} className="flex items-start gap-4">
                    <span
                      ...
                      style={{ color: '#00C2C7', marginTop: 3 }}
                    >
                      ✓
                    </span>
                    <div>
              ...
              >
                Corvus is built by{' '}
                <Link href="/about" style={{ color: '#00C2C7' }}>Old Crows Wireless Solutions</Link>
            ...
            {[
              {
                ...
                a: 'Download the Crow\'s Eye app on Android, open it, and tap Scan. Corvus handles the RF scanning automatically — no screenshots or third-party apps needed.',
              },
              {
                q: 'Does this require account creation?',
                a: 'No. Enter your name, email, and event code. Corvus accesses your granted credits by email when you run a Verdict.',
              },
              {
                q: 'Can I use my Verdict after the event?',
                a: 'Verdict credits and chat access expire May 10, 2026. Use them before then.',
              },
              {
                q: 'What if I want more after my free Verdict?',
                a: 'Verdicts are $50 each, or subscribe starting at $20/month for a bundle. See pricing.',
              },
            ].map(({ q, a }) => (
