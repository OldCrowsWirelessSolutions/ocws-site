        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl p-8" style={{ background: "#1A2332", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <div className="space-y-6">
              ...
              {/* Clarity Guarantee */}
              <div className="rounded-xl p-5" style={{ background: "rgba(34,214,220,0.06)", border: "1px solid rgba(34,214,220,0.25)" }}>
                <h3 className="text-base font-bold mb-3" style={{ color: "#22D6DC" }}>The Clarity Guarantee</h3>
                <p className="text-sm leading-relaxed mb-3" style={{ color: "#aaa" }}>
                  Every WiFi Health Report, Whole-Home Survey, and output produced by Corvus, Crow&rsquo;s Eye, or any other OCWS product will be written in plain English that a non-engineer can understand. Findings will not be obscured in technical jargon. If you receive a Corvus output and the findings are not clearly explained in terms you can act on, contact us and we will clarify them at no additional charge.
                </p>
                <p className="text-sm leading-relaxed" style={{ color: "#aaa" }}>
                  This guarantee covers the language, structure, and readability of the output itself — not the nature of the findings or whether the underlying WiFi issues are resolvable.
                </p>
              </div>

              {/* Actionable Output Guarantee */}
              <div className="rounded-xl p-5" style={{ background: "rgba(34,214,220,0.06)", border: "1px solid rgba(34,214,220,0.25)" }}>
                <h3 className="text-base font-bold mb-3" style={{ color: "#22D6DC" }}>The Actionable Output Guarantee</h3>
                <p className="text-sm leading-relaxed mb-3" style={{ color: "#aaa" }}>
                ...
                <p className="text-sm leading-relaxed mb-3" style={{ color: "#aaa" }}>
                  This guarantee applies to Corvus-generated WiFi Health Reports and Whole-Home Surveys. It applies to the existence and specificity of recommendations — not to the outcomes of implementing them, which depend on factors outside Corvus&rsquo;s control.
                </p>
                <p className="text-sm leading-relaxed" style={{ color: "#aaa" }}>
          ...
          <div className="rounded-2xl p-8" style={{ background: "#1A2332", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <p className="text-xs font-semibold uppercase tracking-widest mb-4" style={{ color: "#22D6DC" }}>
            ...
            <div className="space-y-3 text-sm" style={{ color: "#aaa" }}>
              ...
              <div className="flex items-start gap-3">
                <span className="shrink-0 mt-0.5 font-bold" style={{ color: "#888" }}>✗</span>
                <div>
                  <span className="text-white font-semibold">Interference elimination.</span> WiFi interference from neighboring networks, building materials, or external sources may be identified but cannot be guaranteed to be resolvable through customer action alone.
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="shrink-0 mt-0.5 font-bold" style={{ color: "#888" }}>✗</span>
              ...
              <div className="flex items-start gap-3">
                <span className="shrink-0 mt-0.5 font-bold" style={{ color: "#888" }}>✗</span>
                <div>
                  <span className="text-white font-semibold">Monitoring completeness or continuity.</span> Crow&rsquo;s Eye monitoring outputs are based on what is observable from submitted scan data at the time of scanning. Continuous, real-time, or gap-free WiFi monitoring is not guaranteed.
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="shrink-0 mt-0.5 font-bold" style={{ color: "#888" }}>✗</span>
