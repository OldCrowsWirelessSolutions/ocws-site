...
export const metadata: Metadata = {
  ...
  description:
    "WiFi Health Reports, the Whole-Home Survey, OCWS Pro Certified \u2014 AI-powered Wi-Fi diagnostics and on-site WiFi assessment from Old Crows Wireless Solutions.",
};
    ...
    <main style={{ background: "#0D1520", minHeight: "100vh" }}>
      <section className="ocws-container py-16">
        ...
        <div className="space-y-8 mb-16">
          ...
          {/* Corvus' Verdict */}
          <div className="rounded-2xl overflow-hidden" style={{ background: "#1A2332", borderTop: "3px solid #22D6DC" }}>
            <div className="p-8">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div>
                  <h2 className="text-2xl font-bold text-white mb-1">WiFi Health Report</h2>
                  <p className="text-sm font-semibold" style={{ color: "#22D6DC" }}>Single analysis &middot; $50 &middot; No account required</p>
                </div>
                <Link href="/crows-eye" className="shrink-0 inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-bold ocws-glow-hover" style={{ background: "#22D6DC", color: "#0D1520" }}>
                  Get Your WiFi Health Report
                </Link>
              </div>
              <p className="text-sm leading-relaxed mb-5" style={{ color: "#aaa" }}>
                Open Crow&rsquo;s Eye and tap Scan. Corvus reads your entire WiFi environment automatically &mdash;
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {["Full AI WiFi environment diagnosis","Channel saturation and interference analysis","Router vendor identification from MAC OUI","Step-by-step fix instructions per router","Security posture assessment","Branded PDF report \u2014 yours to keep"].map((f) => (
                  <div key={f} className="flex items-start gap-2 text-sm" style={{ color: "#ccc" }}>
                    <span style={{ color: "#22D6DC", flexShrink: 0 }}>✓</span><span>{f}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          {/* The Full Reckoning */}
          <div className="rounded-2xl overflow-hidden" style={{ background: "#1A2332", borderTop: "3px solid #D8AC32" }}>
            <div className="p-8">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div>
                  <h2 className="text-2xl font-bold text-white mb-1">The Whole-Home Survey</h2>
                  <p className="text-sm font-semibold" style={{ color: "#D8AC32" }}>Multi-location site survey &middot; From $150</p>
                </div>
                <Link href="/crows-eye" className="shrink-0 inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-bold ocws-glow-hover-gold" style={{ border: "1px solid #D8AC32", color: "#D8AC32", background: "transparent" }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
                {[{tier:"Small Site",locs:"Up to 5 locations",price:"$150"},{tier:"Standard Site",locs:"6\u201315 locations",price:"$350"},{tier:"Commercial Site",locs:"16+ locations",price:"$750"}].map(({ tier, locs, price }) => (
                  <div key={tier} className="rounded-xl p-4 text-center" style={{ background: "#0D1520", border: "1px solid rgba(216,172,50,0.25)" }}>
              ...
              <p className="text-xs" style={{ color: "#888" }}>Properties with detached structures require a minimum Standard Whole-Home Survey ($350). Hybrid Property mode analyzes signal relationships between all structures.</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: "#1A2332", borderTop: "3px solid #D8AC32" }}>
            <div className="p-8">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                <div>
                  <h2 className="text-2xl font-bold text-white mb-1">OCWS Pro Certified Whole-Home Survey</h2>
                  <p className="text-sm font-semibold" style={{ color: "#D8AC32" }}>Joshua certifies every finding &middot; $1,500 &middot; Any size facility</p>
                </div>
                <Link href="/contact" className="shrink-0 inline-flex items-center justify-center rounded-xl px-5 py-2.5 text-sm font-bold ocws-glow-hover-gold" style={{ border: "1px solid rgba(216,172,50,0.5)", color: "#D8AC32", background: "transparent" }}>
                  Request Pro Survey
                </Link>
              </div>
              <p className="text-sm leading-relaxed mb-5" style={{ color: "#aaa" }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {["Full Whole-Home Survey \u2014 all locations included","Personal certification by Joshua Turner","Valid for compliance and legal documentation","Insurance claim and vendor quote support","Board-ready professional report format","17 years Navy EW expertise behind every cert"].map((f) => (
                  <div key={f} className="flex items-start gap-2 text-sm" style={{ color: "#ccc" }}>
                    <span style={{ color: "#D8AC32", flexShrink: 0 }}>✓</span><span>{f}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="rounded-2xl p-8 mb-12" style={{ background: "#1A2332", borderLeft: "4px solid #0D6E7A" }}>
          <h2 className="text-2xl font-bold text-white mb-2">On-Site WiFi Assessment</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            <div className="rounded-xl p-5" style={{ background: "#0D1520", border: "1px solid #0D6E7A" }}>
              ...
              <div className="text-2xl font-bold" style={{ color: "#22D6DC" }}>$250 flat</div>
            </div>
            <div className="rounded-xl p-5" style={{ background: "#0D1520", border: "1px solid #0D6E7A" }}>
              ...
              <div className="text-2xl font-bold" style={{ color: "#22D6DC" }}>$375</div>
            ...
            <div className="rounded-xl p-5" style={{ background: "rgba(0,0,0,0.2)", border: "1px solid rgba(255,255,255,0.06)" }}>
              ...
              <p className="text-sm" style={{ color: "#666" }}>Crow&rsquo;s Eye WiFi Health Report recommended instead</p>
            </div>
          </div>
          <p className="text-xs mb-1" style={{ color: "#D8AC32" }}>Service area: Pensacola metro through Northwest FL to Mobile AL. $125 travel fee for locations more than 50 miles round trip from Pensacola.</p>
          ...
          <Link href="/contact" className="inline-flex items-center justify-center rounded-xl px-6 py-3 text-sm font-bold ocws-glow-hover" style={{ background: "#22D6DC", color: "#0D1520" }}>
        ...
        <div className="text-center py-12 rounded-2xl" style={{ background: "#0D6E7A" }}>
          <h2 className="text-3xl font-bold text-white mb-3">Download the app and get your WiFi Health Report.</h2>
