      ...
      <section className="ocws-container py-16">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start mb-16">
          ...
          <div className="shrink-0 w-full md:w-auto flex justify-center">
            <div
              ...
              style={{
                width: "300px",
                height: "400px",
                border: "2px solid #D8AC32",
                boxShadow: "0 0 0 6px rgba(216,172,50,0.12), 0 8px 40px rgba(0,0,0,0.5)",
              }}
            >
          ...
          <div className="flex-1">
            ...
            <p className="text-sm font-semibold mb-6" style={{ color: "#22D6DC" }}>
            ...
            <div
              ...
              style={{ borderLeft: "3px solid #D8AC32" }}
            >
              <p className="text-sm italic" style={{ color: "#D8AC32" }}>
        ...
        >
          ...
          <p className="text-base leading-relaxed" style={{ color: "#aaa" }}>
            ...
            Nobody looks at the actual WiFi environment. Corvus looks. He delivers a WiFi Health
            Report. And he tells you exactly what to do about it.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-base leading-relaxed" style={{ color: "#aaa" }}>
            ...
            discipline, the same obsession with the wireless environment, the same commitment to getting
        ...
        >
          ...
          <p className="text-base leading-relaxed" style={{ color: "#aaa" }}>
            ...
            corridors. Wireless physics doesn&rsquo;t change by geography. The spectrum is the spectrum.
