        ...
        <div className="ocws-tile px-5 py-6 md:px-8 md:py-10">
          ...
          <div className="mt-8 grid grid-cols-1 gap-4">
            <Card
              ...
              body="When neighboring APs share a channel, devices take turns. More APs can actually reduce performance if channel reuse isn’t planned."
            />
            <Card
              title="Channel width matters"
              body="Wider channels can increase peak speed in clean environments, but in real neighborhoods or businesses they often increase collisions and reduce reliability."
            />
            <Card
              title="Why “auto” often fails"
              body="Auto channel algorithms can chase short-term noise and fight neighboring routers. A stable channel plan often beats constant shifting."
            />
            <Card
              title="What OCWS changes"
              body="We measure utilization, interference, and coverage; then we set a channel plan and AP placement that matches the environment—not a generic default."
            />
          </div>
        </div>
      </section>
